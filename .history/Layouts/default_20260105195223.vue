<template>
    <div>
      ...
      <div class="language-switcher container mt-3 mb-5">
        ...
        <select id="lang-select" v-model="locale.value" class="form-select w-auto d-inline-block">
          <option value="fr">FR</option>
          <option value="en">EN</option>
        </select>
        <span class="ms-2">Langue actuelle : {{ locale.value.toUpperCase() }}</span>
      </div>
  ...
  // Nuxt I18n
  const { t, locale } = useI18n(); // locale est un ref ✅
