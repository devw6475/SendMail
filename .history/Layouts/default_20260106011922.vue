<template>
  <div>
    ...
    <select :value="choiceLanguage" :v-model="choiceLanguage" @change="changeLocale($event)" class="form-select lang-switcher">
      <option v value="fr">FR</option>
...
const { isOpen, choiceLanguage, handleResize, changeLanguage, toggleMenu, closeMenu } = useFunctions();
