      ...
      <a-form layout="vertical">
        ...
        <template v-if="form.type_carte === 'card'">
          <a-form-item label="Numéro de carte">
            <a-input v-model:value="form.card_number" placeholder="1234 5678 9012 3456" />
          </a-form-item>
        ...
        <!-- CONDITIONS -->
        <a-form-item>
          <a-checkbox v-model:value="check" @change="() => console.log('check', check)">
            J'accepte la
        ...
        <!-- ACTION -->
        <a-button :disabled="disabled" type="primary" block> Activer mon ticket </a-button>
      </a-form>
    </a-modal>
  </div>
</template>
...
const { disabled, check, form, openModal } = useFunctions();
</script>
