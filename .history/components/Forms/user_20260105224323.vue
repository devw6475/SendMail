      ...
      <a-form layout="vertical">
        ...
        <a-form-item>
          <a-checkbox v-model:checked="check" @change="() => console.log('check', check)">
            J'accepte la
            <a href="#" target="_blank">politique de confidentialité</a> et j'accepte la collecte de mes informations personnelles conformément aux 
            <a href="#" target="_blank">Mentions</a>
          </a-checkbox>
        </a-form-item>
