      ...
      <a-form layout="vertical">
        ...
        <a-form-item>
          <a-checkbox v-model:checked="check" @change="() => console.log('check', check)">
            J'accepte la <span class="text-primary">politique de confidentialité</span> et j'accepte la <span class="text-primary">collecte de mes informations personnelles</span>
          </a-checkbox>
        </a-form-item>
