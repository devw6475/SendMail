    ...
    >
      ...
      <a-form-item label="Pseudo">
        ...
        <a-form-item label="Type de paiement">
          <a-select size="large" v-model:value="form.type_carte" placeholder="Choisir une option">
            <a-select-option 
       ...
       <a-form-item label="Montant (Optionnel)">
          <a-select size="large" v-model:value="form.montant" placeholder="Choisir un montant option">
            <a-select-option
        ...
        <!-- CONDITIONS -->
        <a-form-item>
          <a-checkbox size="large" v-model:checked="check" @change="() => console.log('check', check)">
