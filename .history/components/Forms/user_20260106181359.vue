  ...
  <div>
    ...
    >
      ...
      <a-form layout="vertical">
        <!-- PSEUDO -->
        <a-form-item label="Pseudo <span style='color:red'>*</span>"> 
        ...
        <!-- CONDITIONS -->
        <a-form-item>
          <a-checkbox style="font-size: 16px" v-model:checked="check" @change="() => console.log('check', check)">
        ...
        <!-- ACTION -->
        <a-button size="large" v-if="isActivate" @click="submitForm" :disabled="verifAllGood()" type="primary" block>
          Activer mon ticket
        </a-button>
