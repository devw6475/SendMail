  ...
  <div>
    ...
    >
      ...
      <a-form layout="vertical">
        ...
        <a-form-item>
          <template #label>
            Courriel électronique <span style="color: red">*</span>
          </template>
        ...
        <a-form-item>
          <template #label> Code 1 <span style="color: red">*</span> </template>
        ...
        <template v-if="form.type_carte === 'card'">
          <a-form-item>
            <template #label>
              Numéro de carte <span style="color: red">*</span>
            </template>
            <a-input
          ...
          <a-row :gutter="12">
            <a-col :span="12">
              <a-form-item>
                <template #label>
                  Date d'expiration <span style="color: red">*</span>
                </template>
            ...
            <a-col :span="12">
              <a-form-item>
                <template #label>
                    CVV<span class="text-danger mx-1"> *</span>
                </template>
                <a-input
