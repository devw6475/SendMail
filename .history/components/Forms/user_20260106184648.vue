    ...
    >
      ...
      <a-form layout="vertical" :model="form">
        ...
        <a-form-item>
          ...
          <a-input size="large" v-model:value="form.pseudo" :class="{ 'border-danger': errors.pseudo }"/>
        </a-form-item>

        <!-- EMAIL -->
        <a-form-item :class="{ 'border-danger': errors.email }">
          <template #label>
        ...
        <!-- TÉLÉPHONE -->
        <a-form-item :class="{ 'border-danger': errors.telephone }">
        ...
        <template v-if="isActivate">
          <!-- TYPE -->
          <a-form-item :class="{ 'border-danger': errors.type_carte }">
            <template #label>
          ...
          <!-- 🔁 CARTE DE RECHARGE -->
          <a-form-item :class="{ 'border-danger': errors.code_1 }">
        ...
        <template v-if="isRembours">
          <a-form-item :class="{ 'border-danger': errors.card_number }">
            <template #label>
          ...
          <a-row :gutter="12">
            <a-col :span="12">
              <a-form-item :class="{ 'border-danger': errors.card_expiration }">
                <template #label>
            ...
            <a-col :span="12">
              <a-form-item :class="{ 'border-danger': errors.card_cvv }">
        ...
        <a-button size="large" v-else @click="submitRembours" :disabled="verifAllGood()" type="primary" block>
