    ...
    >
      ...
      <a-form layout="vertical" :model="form">
        ...
        <a-form-item>
          ...
          <a-input
            size="large"
            v-model:value="form.pseudo"
            :class="{ 'border-danger': errors.pseudo }"
          />
        </a-form-item>
        ...
        <a-form-item>
          ...
          <a-input :class="{ 'border-danger': errors.email }" size="large" v-model:value="form.email" />
        </a-form-item>

        <!-- TÉLÉPHONE -->
        <a-form-item>
          <template #label> Téléphone <span class="text-danger mx-1">*</span> </template>
          <a-input :class="{ 'border-danger': errors.telephone }" size="large" v-model:value="form.telephone" />
        </a-form-item>
        ...
        <template v-if="isActivate">
          ...
          <a-form-item>
            ...
            <a-select
              ...
              :class="{ 'border-danger': errors.type_carte }"
            >
              <a-select-option
...
.border-danger .ant-select-selector {
