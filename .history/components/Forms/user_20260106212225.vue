    ...
    >
      ...
      <a-form layout="vertical" :model="form">
        ...
        <a-form-item>
          ...
          <a-input size="large" v-model:value="form.pseudo" />
        </a-form-item>

        <!-- EMAIL -->
        <a-form-item :validate-status="errors.email ? 'error' : ''"
        :help="errors.email ? 'Email invalide' : ''">
          <template #label>
            Courriel électronique <span class="text-danger mx-1">*</span>
          </template>
          <a-input @blur="checkEmail" size="large" v-model:value="form.email" />
        </a-form-item>
